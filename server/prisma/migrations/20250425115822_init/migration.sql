...
-- CreateEnum
CREATE TYPE "Highlight" AS ENUM ('HighSpeedInternetAccess', 'WasherDryer', 'AirConditioning', 'Heating', 'SmokeFree', 'CableReady', 'SatelliteTV', 'DoubleVanities', 'TubShower', 'Intercom', 'SprinklerSystem', 'RecentlyRenovated', 'CloseToTransit', 'GreatView', 'QuietNeighborhood', 'WheelchairAccessible', 'BalconyOrPatio', 'Fireplace', 'PrivateEntrance', 'SmartHomeFeatures', 'EnergyEfficientAppliances', 'GatedCommunity', 'RooftopAccess', 'SecureParking', 'OnSiteManagement', 'PetFriendly', 'BalconyView', 'ModernAppliances', 'NearSchool', 'NearHospital');

-- CreateEnum
CREATE TYPE "Amenity" AS ENUM ('WasherDryer', 'AirConditioning', 'Dishwasher', 'HighSpeedInternet', 'HardwoodFloors', 'WalkInClosets', 'Microwave', 'Refrigerator', 'Pool', 'Gym', 'Parking', 'PetsAllowed', 'WiFi', 'Heating', 'CableReady', 'SatelliteTV', 'SmokeFree', 'WheelchairAccessible', 'BalconyOrPatio', 'Fireplace', 'SecuritySystem', 'Elevator', 'Furnished', 'Storage', 'LaundryFacilities', 'CommunityLounge', 'BusinessCenter', 'Playground', 'BarbecueArea', 'TennisCourt', 'Clubhouse', 'Spa', 'RooftopAccess', 'FireExtinguisher', 'SmokeDetectors', 'SolarPanels', 'Garden', 'SecurityCameras');

-- CreateEnum
CREATE TYPE "PropertyType" AS ENUM ('Rooms', 'TinyHouse', 'Apartment', 'Villa', 'Townhouse', 'Cottage', 'Studio', 'Duplex', 'Penthouse', 'Bungalow', 'Farmhouse', 'CoLivingSpace');
...
-- CreateEnum
CREATE TYPE "AvailabilityStatus" AS ENUM ('Available', 'Rented', 'UnderOffer');
